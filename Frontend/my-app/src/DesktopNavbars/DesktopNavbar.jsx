...
function DesktopNavbar() {
  ...
  return (
    <>
      ...
      >
        <div
          className="p-0 px-2 d-flex flex-column"
          style={{
            border: "none",
        ...
        >
          <div
            ...
            style={{ border: "", marginBottom: "7vh", marginTop: "5vh" }}
          >
            <div
              className={`p-0  d-flex justify-content-center ${
                showExtraText ? "justify-content-xl-start" : ""
              }`}
              style={{ border: "", backgroundColor: "transparent" }}
            >
              <button
                onClick={() => {
                  handleDesktopOnlyNavbarType("");
                  navigate("/");
                }}
                className={`${styles.zenLoop}  d-xl-flex p-0`}
                style={{
                  border: "none",
                  backgroundColor: "transparent",
                  color: "black",
              ...
              >
                {showExtraText ? null : (
                  <div className="p-0 m-0" style={{ border: "" }}>
                    <InstagramIcon />
                  </div>
                )}
                {!showExtraText ? null : (
                  <div className="p-0 d-block d-xl-none">
                    <InstagramIcon />
                  </div>
                )}
                <div
            ...
            >
              ...
              >
                <HomeIcon />
                <div className="p-0 ms-3 d-none d-xl-block">
                  {showExtraText ? "Home" : ""}
                </div>
              </button>
            </div>
            ...
            >
              <button
                className="p-0 d-flex"
                onClick={() => handleDesktopOnlyNavbarType("Search")}
                style={{
                  border: "none",
                  backgroundColor: "transparent",
                  color: "black",
              ...
              >
                ...
                <div
                  style={divStyle}
                  onMouseEnter={() =>
                    setDivStyle((prev) => ({ ...prev, cursor: "pointer" }))
                  }
                  className="p-0 ms-3 d-none d-xl-block"
                >
                  {showExtraText ? "Search" : ""}
                </div>
              </button>
            </div>
            <div
            ...
            >
              <button
                className="p-0 d-flex"
                onClick={() => {
                  handleDesktopOnlyNavbarType("Messages");
            ...
            >
              ...
              >
                <UserPFPIcon
                  src={user.pfpFirebasePathURL ? user.pfpFirebasePathURL : null}
                />
                <div className="p-0 ms-3 d-none d-xl-block">
                  {showExtraText ? "Profile" : ""}
                </div>
              </button>
            </div>
          </div>
        </div>
        <DesktopOnlyNavbarExtended
          desktopOnlyNavbarType={desktopOnlyNavbarType}
          setDesktopOnlyNavbarType={setDesktopOnlyNavbarType}
        />
      </div>
    </>
  );
