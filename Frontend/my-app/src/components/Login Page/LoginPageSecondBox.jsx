...
function LoginPageSecondBox() {
  ...
  return (
    ...
    >
      <section
        className={`${styles.conditionalBorder} pb-5 d-flex flex-column align-items-center`}
      >
        ...
        >
          <PasswordField
            ...
            passwordFieldOnChange={handleChange}
            passwordFieldOnKeyDown={handleKeyDown}
          />
        </div>
        ...
        >
          <button
            ...
            style={{ width: "268px", height: "50%" }}
            className="btn btn-info mt-5 text-light"
          >
            Log in
          </button>
        </div>
      ...
      <section className="mt-3 text-center d-flex flex-column align-items-center">
        <div>Get the app.</div>
        <div className="mt-3" style={{ width: "350px", height: "44px" }}>
          <AppStoreDownload /> <GooglePlayDownload />
        </div>
      </section>
    </div>
  );
