  ...
  return (
   ...
   <div className='d-flex flex-column flex-md-row' style={{height:'100vh'}}>
    ...
    <div className='d-flex flex-column align-items-center' style={{border:'',flex:1}}>
      ...
      <div className='mt-4 text-center'> <text> The link you followed may be broken, or the page may have been removed. <button onClick={()=> navigate('/')} style={{textDecoration:'none',color:'#405D72'}}>Go back to Instagram.</button></text></div>
    </div>
